...
# -----------------------------------------------------------------------------
# 1. Pruebas para Portfolio Global (PUT)
# -----------------------------------------------------------------------------
...
@pytest.mark.asyncio
async def test_create_and_read_project(client, auth_headers, sample_project_payload):
    ...
    # 2. Consultar la lista pública de proyectos
    get_response = await client.get("/api/v1/portfolio/projects")
